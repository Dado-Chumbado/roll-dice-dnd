{
    ...
    "command_critical_damage": "cd",

    "command_initiative": "i",

    "command_initiative_adv": "i-v",
    "command_force_initiative": "i-fixa",

    "command_reset": "i-limpar",
    ...
    "command_show_stats_player": "my-stats",
    "command_show_stats_session": "session-stats",
